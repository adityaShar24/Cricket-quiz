...
from utils.constants import REGISTER_ENDPOINT , USERNAME_MISSING_ERROR , HTTP_400_BAD_REQUEST , PASSWORD_MISSING_ERROR , USERNAME_EXISTS_ERROR , LOGIN_ENDPOINT , USERNAME_NOT_EXISTS_ERROR
...
def login_middleware():
    if request.endpoint == LOGIN_ENDPOINT:
        ...
        if not existing_user:
            return make_response({'message': USERNAME_NOT_EXISTS_ERROR} , HTTP_400_BAD_REQUEST)
